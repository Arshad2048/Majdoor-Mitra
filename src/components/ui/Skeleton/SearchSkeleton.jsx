...
export const PostCardSkeleton = () => (
    <div className="post-card-v2" style={{ pointerEvents: 'none', marginBottom: '16px' }}>
...
const SearchSkeleton = () => (
    <div className="search-page" style={{ pointerEvents: 'none' }}>
        <div className="search-header-bar">
            <div className="search-back-btn">
                <Skeleton variant="circle" width="20px" height="20px" />
            </div>
            <div className="search-input-wrapper" style={{ background: '#f1f5f9' }}>
                <Skeleton variant="circle" width="18px" height="18px" />
                <Skeleton variant="text" width="70%" height="1rem" style={{ marginLeft: '12px' }} />
            </div>
        </div>
        <div className="popular-searches-container">
            ...
            <div className="popular-pills">
                {[1, 2, 3, 4, 5, 6, 7].map(i => (
                    <Skeleton key={i} variant="rect" width="100px" height="36px" style={{ borderRadius: '20px' }} />
                ))}
            </div>
        </div>
    </div>
